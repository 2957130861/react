...
<<<<<<< HEAD
    ...
    // 后端
   router.get('/showLocalUser',controller.user.userController.showLocalUser);
   router.get('/showRootUser',controller.user.userController.showRootUser);
   router.get('/deleteUser',controller.user.userController.deleteUser);
   router.post('/addUser',controller.user.userController.addUser);
   router.get('/showBook',controller.books.bookController.showBook);
   router.get('/deleteBook',controller.books.bookController.deleteBook);
   router.post('/addBook',controller.books.bookController.addBook);
   router.get('/showUserprivatewrite',controller.privite.priviteController.showUserprivatewrite);
   router.get('/deleteUserprivatewrite',controller.privite.priviteController.deleteUserprivatewrite);
   router.post('/addUserprivatewrite',controller.privite.priviteController.addUserprivatewrite);
=======
>>>>>>> 0d0ffb498caaa8939dd587c919441e17e192961d
}